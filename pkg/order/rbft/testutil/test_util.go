...
func MockOrderConfig(logger logrus.FieldLogger, ctrl *gomock.Controller, t *testing.T) *order.Config {
	...
	nodes[0] = &pb.VpInfo{Id: uint64(1), Account: account.String(), Pid: "1"}
	nodes[1] = &pb.VpInfo{Id: uint64(2), Pid: "2"}
	nodes[2] = &pb.VpInfo{Id: uint64(3), Pid: "3"}
	nodes[3] = &pb.VpInfo{Id: uint64(4), Pid: "4"}
